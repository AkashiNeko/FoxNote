...
tag:
  - 进程
  - PCB
excerpt: 进程是Linux操作系统中正在运行的程序，它们执行特定的任务并占用系统资源。通过进程控制，操作系统能够管理和调度这些进程，实现多任务并发执行。
---
...
Linux操作系统使用链表管理各进程的 `task_struct`，这个链表称为**任务队列**。
...
~~~text
top - 20:32:16 up 12:41,  2 users,  load average: 0.01, 0.09, 0.13
